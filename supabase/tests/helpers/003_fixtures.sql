...
--
-- Reihenfolge wichtig: agenturen VOR auth.users, weil der
-- handle_new_user()-Trigger (Migration 20260711140000) synchron bei jedem
-- auth.users-Insert eine nutzer-Zeile mit agentur_id-FK anlegt. Der Trigger
-- ist fail-closed und verlangt agentur_id/rolle in raw_user_meta_data; ein
-- separater "INSERT INTO nutzer"-Block entfällt deshalb hier (würde mit der
-- vom Trigger angelegten Zeile kollidieren).
...
-- Der handle_new_user()-Trigger legt aus raw_user_meta_data automatisch die
-- passende nutzer-Zeile an (agentur_id, name, rolle).
-- ============================================================

INSERT INTO auth.users (id, email, raw_user_meta_data) VALUES
  ('a0000000-0000-0000-0000-000000000101', 'chef-a@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000001", "rolle": "chef", "name": "Chef A (Test)"}'),
  ('a0000000-0000-0000-0000-000000000102', 'manager-a@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000001", "rolle": "manager", "name": "Manager A (Test)"}'),
  ('a0000000-0000-0000-0000-000000000103', 'editor-a1@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000001", "rolle": "editor", "name": "Editor A1 (Test)"}'), -- zuständig für sensitiven Vorgang
  ('a0000000-0000-0000-0000-000000000104', 'editor-a2@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000001", "rolle": "editor", "name": "Editor A2 (Test)"}'), -- gleicher Kunde, NICHT zuständig
  ('a0000000-0000-0000-0000-000000000105', 'reader-a@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000001", "rolle": "reader", "name": "Reader A (Test)"}'),
  ('a0000000-0000-0000-0000-000000000106', 'guest-a@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000001", "rolle": "guest", "name": "Guest A (Test)"}'),
  ('a0000000-0000-0000-0000-000000000201', 'chef-b@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000002", "rolle": "chef", "name": "Chef B (Test)"}'), -- andere Agentur
  ('a0000000-0000-0000-0000-000000000202', 'editor-b@fixtures.test',
   '{"agentur_id": "a0000000-0000-0000-0000-000000000002", "rolle": "editor", "name": "Editor B (Test)"}'); -- andere Agentur
